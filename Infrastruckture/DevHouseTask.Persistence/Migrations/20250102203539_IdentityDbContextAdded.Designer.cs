...
namespace DevHouseTask.Persistence.Migrations
{
    ...
    [Migration("20250102203539_IdentityDbContextAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHouseTask.Domain.Entities.Auth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DevHouseTask.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DevHouseTask.Domain.Entities.PermissionDetail", b =>
                {
                    ...
                    b.HasOne("DevHouseTask.Domain.Entities.Role", null)
                        .WithMany("PermissionDetail")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("DevHouseTask.Domain.Entities.Auth", null)
                        .WithMany()
