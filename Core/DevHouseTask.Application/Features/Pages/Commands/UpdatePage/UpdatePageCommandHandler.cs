...
{
    public class UpdatePageCommandHandler : IRequestHandler<UpdatePageCommandRequest>
    {
        ...
        public async Task Handle(UpdatePageCommandRequest request, CancellationToken cancellationToken)
        {
